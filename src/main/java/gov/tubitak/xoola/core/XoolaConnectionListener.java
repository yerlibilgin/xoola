...
public interface XoolaConnectionListener {
  void connected(XoolaInvocationHandler xoolaInvocationHandler, XoolaChannelState xcs);

  void disconnected(XoolaInvocationHandler xoolaInvocationHandler, XoolaChannelState xcs);
}
