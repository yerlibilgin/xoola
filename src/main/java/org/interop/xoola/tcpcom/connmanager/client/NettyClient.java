...
public class NettyClient extends XoolaNettyHandler {
   ...
   public NettyClient(Properties properties, XoolaInvocationHandler xoolaHandler) {
      ...
      this.clientId = properties.getProperty(XoolaProperty.CLIENTID, XoolaPropertyDefaults.CLIENTID);
      this.serverHost = properties.getProperty(XoolaProperty.HOST, XoolaPropertyDefaults.HOST);
      this.pingTimeout = Integer.parseInt(properties.getProperty(XoolaProperty.PING_TIMEOUT, XoolaPropertyDefaults.PING_TIMEOUT));
      this.reconnectRetryTimeout = Integer.parseInt(properties.getProperty(XoolaProperty.RECONNECT_RETRY_TIMEOUT, XoolaPropertyDefaults.RECONNECT_RETRY_TIMEOUT));
      this.connectTimeout = Integer.parseInt(properties.getProperty(XoolaProperty.NETWORK_RESPONSE_TIMEOUT, XoolaPropertyDefaults.NETWORK_RESPONSE_TIMEOUT));
